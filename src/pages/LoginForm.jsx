...
import NonSensitiveInputGroup from "../components/InputGroup/NonSensitiveInputGroup";
import SensitiveInputGroup from "../components/InputGroup/SensitiveInputGroup";
...
export default function LoginForm(props) {
    ...
    return (
        <div className="d-flex mt-4 justify-content-center login-container">
            {errorMessage && (
            ...
            <form onSubmit={formik.handleSubmit} noValidate>
                <div className="mt-3 border rounded shadow-sm px-5 py-1 pb-3 d-flex flex-column flex align-items-center justify-content-center form-container">
                    ...
                    <div className="d-flex flex-column align-items-center justify-content-center w-100">
                        ...
                        <div className="d-flex flex-row mt-2">
                            ...
                            <Link
                                to="/register"
                                onClick={() =>
                                    dispatch(changePathName("register"))
                                }
